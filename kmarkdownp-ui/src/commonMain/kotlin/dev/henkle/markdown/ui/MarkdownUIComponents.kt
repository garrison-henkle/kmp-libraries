...
data class MarkdownUIComponents(
    val text: UIComponent<UIElement.Text> =
        { element -> MarkdownText(modifier = Modifier.recomposeHighlighter(), element = element) },
    ...
    val inlineLink: UIComponent<InlineUIElement.Link> =
        { element -> MarkdownInlineLink(modifier = Modifier.recomposeHighlighter(), element = element) },
