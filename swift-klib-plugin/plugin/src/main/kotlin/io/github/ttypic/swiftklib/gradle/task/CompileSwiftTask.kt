...
open class CompileSwiftTask @Inject constructor(
    ...
    internal val targetDir: File
        get() = project.layout.buildDirectory.get().asFile.resolve("${EXTENSION_NAME}/$cinteropName/$compileTarget")
    ...
    private fun readSdkPath(): String {
        ...
        return stdout.toString().trim().also { System.err.println("garrison - sdk path is $it") }
    }
