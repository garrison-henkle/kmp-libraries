...
include(":utils")
include(":surreal-kmp")
include(":data-structures:stack")
include(":data-structures:stack-result")
include(":data-structures:radix-tree")
include(":data-structures:queue")
include(":data-structures:bitset")
include(":encoding:url")
include(":encoding:image")